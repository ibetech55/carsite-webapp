...
import { ICarDetailImages, IGetPresignedUrl, IImageRequestBody } from '../../Interfaces/Image';
...
export class ImageService {
  ...
  public getCarDetailImages(carCode: string): Observable<ICarDetailImages> {
    return this._Http.get<ICarDetailImages>(`${this.API_URL}/car-details-image/${carCode}`);
  }
}
