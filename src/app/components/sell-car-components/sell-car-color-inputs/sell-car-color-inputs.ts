...
import { ColorListComponent } from "../../Shared/color-list-component/color-list-component";
...
export class SellCarColorInputs {
  ...
  handleExtColor(color: IColor) {
    this._SellCarFormService.sellCarForm.patchValue({
      exteriorColor: color.label,
      exteriorColorCode: color.color
    })
  }

  handleIntColor(color: IColor) {
    this._SellCarFormService.sellCarForm.patchValue({
      interiorColor: color.label,
      interiorColorCode: color.color
    })
  }
}
